...
modeled a U-shaped relationship for the example data.
...
We run a new figure below with `theme()` code to improve the look.
...
ggplot(pred_load_mixed_distinct, aes(x = load, y = fit, min = lwr, max = upr)) +
  ...
  xlab("sRPE") +
  ylab("Probability of Injury") +
  theme(panel.background = element_blank(),  # removes background panel
